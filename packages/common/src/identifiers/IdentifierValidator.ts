...
export class IdentifierValidator {
   ...
   */
  public static isValidNamespace(
    namespace: string,
  ): boolean {
    return (
   ...
   */
  public static isCanonical(
    identifier: string,
  ): boolean {
    return CANONICAL_IDENTIFIER_REGEX.test(
      identifier,
    );
  }
   ...
   */
  public static validateNamespace(
    namespace: string,
  ): void {
    if (
  ...
  public static validateType(
    ...
    if (
      !IdentifierValidator.isValidType(type)
    ) {
      throw new InvalidIdentifierTypeError(
        type,
      );
    }
  }
   ...
   */
  public static validateLocalId(
    localId: string,
  ): void {
    if (
      !IdentifierValidator.isValidLocalId(
        localId,
      )
    ) {
      throw new InvalidLocalIdentifierError(
        localId,
      );
    }
  }
   ...
   */
  public static validateCanonical(
    identifier: string,
  ): void {
    if (
    ...
    if (
      !IdentifierValidator.isCanonical(
        identifier,
      )
    ) {
      throw new InvalidIdentifierError(
    ...
    IdentifierValidator.validateNamespace(
      namespace,
    );

    IdentifierValidator.validateType(type);

    IdentifierValidator.validateLocalId(
      localId,
    );
  }
